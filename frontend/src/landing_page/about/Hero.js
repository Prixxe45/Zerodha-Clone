...
const Hero = () => {
  return (
    ...
    >
      <h1 className=' fs-4 text-center ' style={{margin:"17vh", marginBottom:"8vh", color:"#424242" }}>We pioneered the discount broking model in India.<br/>
Now, we are breaking ground with our technology.</h1>
      <div className='row border-top m-5 p-5 justify-content-center' style={{fontSize:"1rem",lineHeight:"1.9",fontWeight:"400" }}>
